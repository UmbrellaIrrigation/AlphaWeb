...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Fancytree___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_Fancytree__);
/**
...
var app = new Vue({
    ...
    components: {
        ...
        Fancytree: __WEBPACK_IMPORTED_MODULE_1__components_Fancytree___default.a
    },
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6e8b7500", Component.options)
  } else {
    hotAPI.reload("data-v-6e8b7500", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6e8b7500", module.exports)
  }
}
